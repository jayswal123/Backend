                ...
                <div class="col product_section clearfix">
                    ...
                    <div class="sidebar">
                        <div class="sidebar_section">
                            ...
                            <li><a href="man.php">Men</a></li>
                                ...
                                <li class="active"><a href="accessories.php"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>Accessories</a></li>
                    ...
                    <div class="main_content">
						...
						while ($row = mysqli_fetch_array($Record)){
							$check_cat = $row['pcategory'];
							if($check_cat === 'accessories'){
						...
						?>
                                        ...
                                        <div class="product-item women">
                                            <div class="product product_filter">
                                                ...
                                                <div class="favorite"></div>
                                                <div class="product_info">
                                                    <h6 class="product_name"><a href="single.php">Blue Yeti USB
                                        ...
                                        <div class="product-item accessories">
                                            <div class="product product_filter">
                                                ...
                                                <div class="favorite favorite_left"></div>
                                                <div class="product_info">
                                                    <h6 class="product_name"><a href="single.php">DYMO LabelWriter 450
