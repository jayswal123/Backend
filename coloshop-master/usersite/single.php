					...
					<div class='row'>
						<div class='col-lg-3 thumbnails_col order-lg-1 order-2'>
							<div class='single_product_thumbnails'>
								<ul>
									<li><img src='../Myadmin1/$row[pimage]'></li>
									<li class='active'><img src='../Myadmin1/$row[pimage]'></li>
									<li><img src='../Myadmin1/$row[pimage]'></li>
								</ul>
							</div>
						</div>
						<div class='col-lg-9 image_col order-lg-2 order-1'>
							<div class='single_product_image'>
								<div class='single_product_image_background' style='background-image:url(../Myadmin1/$row[pimage]')'></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class='col-lg-5'>
				<div class='product_details'>
					...
					<div class='quantity d-flex flex-column flex-sm-row align-items-sm-center'>
						...
						<div class='red_button add_to_cart_button'><a href='cart.php? id=$row[id]'>add to cart</a></div>
